...
#  4 - RS (Register Select) connect to G13 (as per call to GpioLcd)
#  5 - RW (Read/Write) - connect to ground
#  6 - EN (Enable) connect to G12 (as per call to GpioLcd)
#  7 - D0 - leave unconnected
#  8 - D1 - leave unconnected
#  9 - D2 - leave unconnected
# 10 - D3 - leave unconnected
# 11 - D4 - connect to G21 (as per call to GpioLcd)
# 12 - D5 - connect to G22 (as per call to GpioLcd)
# 13 - D6 - connect to G23 (as per call to GpioLcd)
# 14 - D7 - connect to G25 (as per call to GpioLcd)
